class Depomain < ApplicationRecord
  ...
  def self.depomainselect
    return Depomain.joins("LEFT OUTER JOIN depomsts depoM1 ON depomains.depo_cd = depoM1.mst_cd and depoM1.mst_type::integer =1 ")
                   .joins("LEFT OUTER JOIN depomsts depoM2 ON depomains.keep_division = depoM2.mst_id and depoM2.mst_type::integer =2 ")
                   .joins("LEFT OUTER JOIN depomsts depoM3 ON depomains.packing_type = depoM3.mst_cd and depoM3.mst_type::integer =3 ")
                   .joins("LEFT OUTER JOIN depomsts depoM4 ON depomains.delivery_car = depoM4.mst_cd and depoM4.mst_type::integer =4 ")
                   .joins("LEFT OUTER JOIN depomsts depoM5 ON depomains.delivery_trader = depoM5.mst_cd and depoM5.mst_type::integer =5 ")
                   .select("depomains.*
